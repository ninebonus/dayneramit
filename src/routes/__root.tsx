...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Day Neramit — ช่างมืออาชีพครบวงจร" },
      { property: "og:description", content: "บริการติดตั้ง ซ่อม ล้างแอร์ CCTV ไฟฟ้า ประปา รีโนเวท และงานช่างครบวงจร มืออาชีพ รับประกันคุณภาพ" },
      { property: "og:type", content: "website" },
      { property: "og:locale", content: "th_TH" },
      { property: "og:site_name", content: "Day Neramit" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Day Neramit — ช่างมืออาชีพครบวงจร" },
      { name: "twitter:description", content: "ทีมช่างมืออาชีพ ติดตั้ง ซ่อม ล้าง แอร์ CCTV ไฟฟ้า ประปา ครบจบที่เดียว" },
    ],
    links: [
